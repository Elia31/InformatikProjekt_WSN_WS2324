...
static void read_eulreg_run(void *o) {
    ...
    bno055.eul_x =		(((uint16_t)read_i2c_buffer[19]) << 8 | ((uint16_t)read_i2c_buffer[18])); 
	bno055.eul_y =		(((uint16_t)read_i2c_buffer[21]) << 8 | ((uint16_t)read_i2c_buffer[20]));
	bno055.eul_z =		(((uint16_t)read_i2c_buffer[23]) << 8 | ((uint16_t)read_i2c_buffer[22]));
...
static void send_eulreg_run(void *o) {
    ...
    char buffer [110]; //muss noch angepasst werden am ende

    sprintf(buffer, "{\"euler\": [%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d]}", bno055.acc_x, bno055.acc_y, bno055.acc_z,
        bno055.gyr_x, bno055.gyr_y, bno055.gyr_z, bno055.mag_x, bno055.mag_y, bno055.mag_z, 
        bno055.eul_x, bno055.eul_y, bno055.eul_z);
